...
<body data-new-gr-c-s-check-loaded="14.1024.0" data-gr-ext-installed="">
        ...
        <form>
            ...
            <table class="border1" width="910" border="1" align="center" cellpadding="0" cellspacing="0" style="width: 1011px;">
                <tbody>
                    ...
                    <tr style="height: 111px;">
                        <td class="border1" style="width: 378.812px; height: 111px; font-size: 11.0pt; font-family: FrutigerExt-Normal; color: black;">
                            &nbsp;Alamat Tujuan&nbsp; &nbsp; &nbsp; :&nbsp;{{ $data_beritam->alamat_tujuan }}</td>
                        <td class="border1" style="width: 436.188px; height: 111px; font-size: 11.0pt; font-family: FrutigerExt-Normal; color: black;">
                            &nbsp;Tanggal&nbsp; &nbsp; &nbsp; &nbsp;
                            :&nbsp;{{ tanggal_indonesia($data_beritam->tanggal_surat) }}</td>
                    </tr>
            ...
            <table width="910" border="1" align="center" cellpadding="0" cellspacing="0" style="width: 1014px; border-color: black;">
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="font-size: 12.0pt; font-family: FrutigerExt-Normal; color: black;" class="border1 text-center">
                ...
                <tbody>
                    <tr>
                        <td style="width: 255px;">
                            <p style="margin: 0cm; text-align: center;" align="center"><span lang="EN-US" style="font-size: 11.0pt; font-family: FrutigerExt-Normal; color: black;">Penerima,</span>
                            </p>
                            <p style="margin: 0cm; text-align: center;" align="center"><span lang="EN-US" style="font-size: 11.0pt; font-family: FrutigerExt-Normal; color: black;">Staf
                                    Umum</span></p>
                            ...
                            <p style="margin: 0cm; text-align: center;" align="center"><span lang="EN-US" style="font-size: 11.0pt; font-family: FrutigerExt-Normal; color: black;">(<u>{{ $data_beritam->tanda1->nama_karyawan }}</u>)</span>
                            </p>
                        </td>
                        <td style="width: 292.091px;">
                            <p style="margin: 0cm; text-align: center;" align="center"><span lang="EN-US" style="font-size: 11.0pt; font-family: FrutigerExt-Normal; color: black;">Mengetahui,</span>
                            </p>
                            <p style="margin: 0cm; text-align: center;" align="center"><span lang="EN-US" style="font-size: 11.0pt; font-family: FrutigerExt-Normal; color: black;">Manager
                                    SDM &amp; Umum</span></p>
                            <p style="margin: 0cm; text-align: center;" align="center"><span lang="EN-US" style="font-size: 11.0pt; font-family: FrutigerExt-Normal; color: black;">&nbsp;</span>
                            </p>
                            <p style="margin: 0cm; text-align: center;" align="center"><span lang="EN-US" style="font-size: 11.0pt; font-family: FrutigerExt-Normal; color: black;">&nbsp;</span>
                            ...
                            <p style="margin: 0cm; text-align: center;" align="center"><span lang="EN-US" style="font-size: 11.0pt; font-family: FrutigerExt-Normal; color: black;">(<u>{{ $data_beritam->tanda2->nama_karyawan }}</u>)</span>
                            </p>
                        </td>
                        <td style="width: 270.909px;">
                            <p style="margin: 0cm; text-align: center;" align="center"><span lang="EN-US" style="font-size: 11.0pt; font-family: FrutigerExt-Normal; color: black;">Pengirim,</span>
                            </p>
                            <p style="margin: 0cm; text-align: center;" align="center"><span lang="EN-US" style="font-size: 11.0pt; font-family: FrutigerExt-Normal; color: black;">Staf SDM
                                    &amp; Umum</span></p>
                            <p style="margin: 0cm; text-align: center;" align="center"><span lang="EN-US" style="font-size: 11.0pt; font-family: FrutigerExt-Normal; color: black;">&nbsp;</span>
                            </p>
                            <p style="margin: 0cm; text-align: center;" align="center"><span lang="EN-US" style="font-size: 11.0pt; font-family: FrutigerExt-Normal; color: black;">&nbsp;</span>
                            ...
                            <p style="margin: 0cm; text-align: center;" align="center"><span lang="EN-US" style="font-size: 11.0pt; font-family: FrutigerExt-Normal; color: black;">(<u>{{ $data_beritam->tanda3->nama_karyawan }}</u>)</span>
                            </p>
                        </td>
                    </tr>
                </tbody>
    ...
    <div class="container-lg text-center mt-4 mb-4">
        ...
        <a href="{{url('admin/beritam/')}}" class="btn btn-success">
            Kembali
        </a>
    </div>
