...
<body data-new-gr-c-s-check-loaded="14.1024.0" data-gr-ext-installed="">
                        ...
                        <td style="width: 1362.67px; height: 223.29px;">
                            ...
                            <ol>
                                <li style="font-size: 11.0pt; font-family: FrutigerExt-Normal; color: black;">Bahwa
                                    ...
                                    {{ $skb->alamat_tujuan }} dengan telepon : {{ $skb->no_telp }}
                                </li>
                            </ol>
                        </td>
                    </tr>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="width: 615.559px;">
                            <p style="margin: 0cm; text-align: center;" align="center"><span lang="EN-US" style="font-size: 11.0pt; font-family: FrutigerExt-Normal; color: black;">Ketapang,{{ tanggal_indonesia($skb->tanggal_surat) }}</span>
                            </p>
                        </td>
                    </tr>
                </tbody>
                ...
                <tbody>
                    <tr>
                        <td style="width: 740.958px;">
                            ...
                            <p style="margin: 0cm; text-align: center;" align="center"><span lang="EN-US" style="font-size: 11.0pt; font-family: FrutigerExt-Normal; color: black;"><u>{{ $skb->tanda1->nama_karyawan }}</u></span>
                            </p>
                        </td>
                        <td style="width: 616.042px;">
                            ...
                            <p style="margin: 0cm; text-align: center;" align="center"><span lang="EN-US" style="font-size: 11.0pt; font-family: FrutigerExt-Normal; color: black;"><u>{{ $skb->tanda2->nama_karyawan }}</u></span>
                            </p>
                        </td>
                    </tr>
                </tbody>
    ...
    <div class="container-lg text-center mt-4 mb-4 pt-4">
        ...
        <a href="{{route('skbhistori.index')}}" type="button" class="btn btn-success">
            Kembali
        </a>
    </div>
