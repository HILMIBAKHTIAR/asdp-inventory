...
<body data-new-gr-c-s-check-loaded="14.1024.0" data-gr-ext-installed="">
                ...
                <tbody>
                    <tr class="border1" style="height: 30px;">
                        <td class="border1" style="width: 378.812px; height: 30px; font-size: 11.0pt; font-family: FrutigerExt-Normal; color: black;">
                            &nbsp;Kepada Yth&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            :&nbsp;{{ $berita->karyawanBerita->jabatan }}</td>
                ...
                <tbody>
                    <tr>
                        <td style="width: 255px;">
                            ...
                            <p style="margin: 0cm; text-align: center;" align="center"><span lang="EN-US" style="font-size: 11.0pt; font-family: FrutigerExt-Normal; color: black;">(<u>{{ $berita->tanda1->nama_karyawan }}</u>)</span>
                            </p>
                        </td>
                        <td style="width: 292.091px;">
                            ...
                            <p style="margin: 0cm; text-align: center;" align="center"><span lang="EN-US" style="font-size: 11.0pt; font-family: FrutigerExt-Normal; color: black;">(<u>{{ $berita->tanda2->nama_karyawan }}</u>)</span>
                            </p>
                        </td>
                        <td style="width: 270.909px;">
                            ...
                            <p style="margin: 0cm; text-align: center;" align="center"><span lang="EN-US" style="font-size: 11.0pt; font-family: FrutigerExt-Normal; color: black;">(<u>{{ $berita->tanda3->nama_karyawan }}</u>)</span>
                            </p>
                        </td>
                    </tr>
                </tbody>
    ...
    <div class="container-lg text-center mt-4 mb-4">
        ...
        <a href="{{route('beritahistori.index')}}" class="btn btn-success">Kembali</a>
    </div>
