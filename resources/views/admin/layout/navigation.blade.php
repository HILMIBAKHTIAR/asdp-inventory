<ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: rgb(56, 145, 166)">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{Route('sp2bj.index')}}" style="margin-top: 40px; margin-bottom: 40px;">
    ...
    <li class="nav-item active">
        <a class="nav-link" href="{{Route('sp2bj.index')}}">
