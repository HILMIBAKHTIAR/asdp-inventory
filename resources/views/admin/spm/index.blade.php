  ...
  <div class="print-area">
    ...
    <form>
      ...
      <table width="910" align="center" cellpadding="0" cellspacing="2" style="width: 960px;">
        ...
        <td style="width: 845.07px; height: 23px; font-size: 11.0pt; font-family: FrutigerExt-Normal; color: black;" >: SDM &amp; Umum</td>
        </tr>
        ...
        <td style="width: 847.289px; height: 23.543px; font-size: 11.0pt; font-family: FrutigerExt-Normal; color: black;">:&nbsp;</td>
        </tr>
        <tr style="height: 23px;">
