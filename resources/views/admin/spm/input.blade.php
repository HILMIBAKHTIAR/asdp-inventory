                    ...
                    <div class="card-footer">
                        ...
                        <form action="{{ route('spm.store') }}" method="post">
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-md-6">
                                        ...
                                        <input name="jenis_transaksi" type="text"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input name="tahun_anggaran" type="date"
                                        ...
                                        <input name="program" type="text"
                                            ...
                                            value="{{ old('program') }}" placeholder="boleh tidak diisi" />
                                        @error('program')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-12 search_select_box">
                                        ...
                                        <select name="devisi" id=""
                                            class="form-control @error('devisi') is-invalid @enderror"
                                            ...
                                            <option value="Teknik Ketapang" @if (old('devisi') == 'Teknik Ketapang') selected="selected" @endif>Teknik Ketapang
                                            </option>
                                ...
                                <div class="form-row">
                                    <div class="col-md-4">
                                        ...
                                        <input name="penerima_dana" type="text" class="form-control"
                                            placeholder="Boleh tidak diisi" value="{{ old('penerima_dana') }}" />
                                    </div>
                                    <div class="col-md-4">
                                        <label>Nomor Rekening</label>
                                        <input name="nomor_rekening" type="text" class="form-control"
                                            placeholder="Boleh tidak diisi" value="{{ old('nomor_rekening') }}" />
                                    </div>
                                    <div class="col-md-4">
                                        <label>Bank</label>
                                        <input name="bank" type="text" class="form-control"
                                            placeholder="Boleh tidak diisi" value="{{ old('bank') }}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                        ...
                                        <select name="ttd1" id="" class="form-control @error('ttd1') is-invalid @enderror"
                                            ...
                                            @foreach ($karyawan as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ old('ttd1') == $item->id ? 'selected' : null }}>
                                    ...
                                    <div class="col-md-4 search_select_box">
                                        ...
                                        <select name="ttd2" id="" class="form-control @error('ttd2') is-invalid @enderror"
                                            ...
                                            @foreach ($karyawan as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ old('ttd2') == $item->id ? 'selected' : null }}>
                                                    {{ $item->jabatan->nama_jabatan }} - {{ $item->nama_karyawan }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-4 search_select_box">
                                        ...
                                        <select name="ttd3" id="" class="form-control @error('ttd3') is-invalid @enderror"
                                            ...
                                            @foreach ($karyawan as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ old('ttd3') == $item->id ? 'selected' : null }}>
                                                    {{ $item->jabatan->nama_jabatan }} - {{ $item->nama_karyawan }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col text-center">
                                ...
                                <input type="submit" class="btn btn-success btn-lg" name="selanjutnya" id="selanjutnya"
                                    value="Selanjutnya" style="padding: 5px 50px; margin-top: 10px;">
